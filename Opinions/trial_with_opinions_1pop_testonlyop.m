...
rx = 1;%0.5;                             % spatial radius for alignment in velocity
...
axis equal;
set(gca,'FontSize',16)
filename1 = fullfile(outputFolder, ['FinalVelocitySegregationNoOp_NL', num2str(NL),'_alpha_',num2str(alpha),'_beta_',num2str(beta),'_Ca_',num2str(Ca),'_la_',num2str(la),'_Cr_',num2str(Cr),'_lr_',num2str(lr),'_rx_',num2str(rx),'_rw_',num2str(rw),'_taur_',num2str(tauright),'_taub_',num2str(tauleft), '.fig']);
...
set(gca,'FontSize',16)
% 
filename4 = fullfile(outputFolder, ['OpinionOverTimeSegregationNoOp', '.fig']);
