classdef NoDelayedCSobject < handle
    ...
    methods (Access  = public)
        ...
        function obj = NoDelayedCSobject()


            %% Parameters
            N = 8;               % Number of agents
            beta = 0.2;            % Decay rate for communication
            ...
            f = @(t, z) obj.swarmingEquation(t, z, N, nDim, beta, tau_max, dt, Ca, la, Cr, lr);
...
%             hold off;
  ...
  %% System of ODEs with Morse Potential
        function dzdt = swarmingEquation(obj,t, z, N, nDim,beta, tau_max, dt, Ca, la, Cr, lr)
...
%                         %end
                        dvdt(:, i) = dvdt(:, i) + (1 / N) * integrand; % Add interaction term
                    end
                end
